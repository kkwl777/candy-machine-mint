              ...
              <div style={{display: 'flex',  justifyContent:'left', alignItems:'left', width: '45%' ,height: '650px', backgroundColor:'#0f1012'}}>
                <div style={{width:'100%' ,padding:'18px', paddingLeft:'36px'}} ><h1 style={{fontFamily:"Cairo" ,fontSize:'48px', }}>100% Royalties + 30% Mint to Sweep the Floor</h1>  <div   style={{ paddingTop:'4px'}}>
                  ...
                  {/*  <p  style={{fontFamily:"Cairo"}}>The Cthuwu Collection consists of 10,00 squids stored on-chain via metaplex candy machine. 
                    ...
                    <p style={{fontFamily: "Cairo"}}> As of October 19th Squids are venturing out into space. Unfortunately, the average squid is not suited space exploration and most of them are not gonna make it. 
 </p>
<p style={{fontFamily: "Cairo"}}>Whether it's because of incompetence or the threat of apex predators like sharks and geckos, Squids lives are lost almost every week. </p>
...
<p  style={{fontFamily: "Cairo"}}>Swept squids will be sent to a burn wallet and thus removed from circulation.</p>
